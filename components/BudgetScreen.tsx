...
const BudgetScreen: React.FC<BudgetScreenProps> = ({ budgets, updateBudgets }) => {
        ...
        <div className="bg-gray-900/50 backdrop-blur-lg rounded-2xl shadow-lg ring-1 ring-white/10 p-6 sm:p-8 max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
                {expenseCategories.map(category => (
                    <div key={category} className="flex items-center justify-between p-4 bg-gray-800/60 rounded-lg ring-1 ring-white/10">
                        <label htmlFor={`budget-${category}`} className="font-medium text-gray-300">{category}</label>
